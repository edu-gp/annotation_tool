...
def kitchen_sink():
    ...
    simple_ar = {
        ...
        "data": {
            ...
            "meta": {"name": "HealthMyne", "domain": "healthmyne.com"},
        },
    }
    ...
    anno_a = {
        "req": real_ar,
        "anno": {"labels": {"Healthcare": 1, "Fintech": -1}},
        "suggested_labels": ["B2C", "Healthcare", "Fintech"],
        "task_id": task.task_id,
        "testing": True,
        "annotation_guides": {
            "B2C": {"html": "Consumer Company, excluding marketplace."},
            "Healthcare": {
                "html": "<b>Anything</b> related to health.<br/>Does not include any related to fitness."
            },
            "Fintech": {"html": "<i>Next generation</i> finance."},
        },
    }
